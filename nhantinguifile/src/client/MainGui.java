...
public class MainGui {
	...
	private void initialize() {
		...
		btnChat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.equals("") || Client.clientarray == null) {
					Tags.show(frameMainGui, "Tên người dùng không hợp lệ", false);
					return;
				}
				if (name.equals(nameUser)) {
					Tags.show(frameMainGui, "Phần mềm này không hỗ trợ chức năng trò chuyện với chính bạn", false);
					return;
				}
				...
				Tags.show(frameMainGui, "Không tìm thấy bạn bè. Vui lòng đợi để cập nhật danh sách bạn bè của bạn", false);
			}
		});
		...
		lblLogo = new JLabel("KẾT NỐI VỚI MỌI NGƯỜI");
		...
		lblActiveNow = new JLabel("Tài khoản hoạt động");
