...
public class ServerGui {
	...
	private void initialize() {
		...
		frmServerMangement.setTitle("Quản lý Server");
		...
		JLabel lblNhom = new JLabel("---QUẢN LÝ SERVER---");
		...
		btnStop.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					server.stopserver();
					ServerGui.updateMessage("DỪNG MÁY CHỦ");
		...
		JMenuItem mntmMe = new JMenuItem("");
		mnNewMenu.add(mntmMe);
		
		JMenuItem mntmSoftware = new JMenuItem("");
		...
		btnStart.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					ServerGui.updateMessage("KHỞI ĐỘNG MÁY CHỦ");
					lblStatus.setText("<html><font color='green'>RUNNING...</font></html>");
				} catch (Exception e) {
					ServerGui.updateMessage("Lỗi khởi động máy chủ");
					e.printStackTrace();
				}
			}
		});
